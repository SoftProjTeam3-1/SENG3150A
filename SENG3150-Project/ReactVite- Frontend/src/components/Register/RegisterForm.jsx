...
const RegisterForm = () => {
  ...
  return (
    <div className={"register-card min-h-screen flex flex-col justify-center items-center"}>
      <ToastContainer>
      ...
      <div className="w-full max-w-sm flex flex-col justify-center mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6 flex flex-col justify-center w-full">
          {/* First Name */}
          <div>
          ...
          <div>
            ...
            onClick={handleSubmit}
                type="submit"
                className="flex w-full justify-center rounded-md bg-orange-400 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-orange-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-2"
            >
              Enter
            </button>
          </div>
          ...
          <div className="w-full">
            <button
              ...
              style={{ minWidth: '100%' }}
            >
              <a href="/" className="w-full block">Back</a>
            </button>
          </div>
        </form>
      </div>
